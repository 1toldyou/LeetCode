...
function solve(board: string[][]): void {
    ...
    const isFillable = (sR: number, sC: number) => {
            ...
            for (let [r, c] of current){
                ...
                for (let i = 0; i < 4; i++){
                    ...
                    if (visited[nR][nC] === true){
                        // console.log("nR", nR, "nC", nC, "visited")
                        continue;
                    }
                    if (board[nR][nC] === "X"){
                        // console.log("nR", nR, "nC", nC, "is-X")
                        continue;
                    }
                    if (nC == 0 || nC == n-1 || nR == 0 || nR == m-1){
                        // console.log("nR", nR, "nC", nC, "is-border")
                        return false;
                    }
